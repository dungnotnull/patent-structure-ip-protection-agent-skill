# -*- coding: utf-8 -*-
"""knowledge_updater.py — self-improving knowledge pipeline for the `patent-structure-ip-protection` skill.
...
ARXIV_CATEGORIES = ['cs.GL', 'eess.SY']
SEARCH_QUERIES = ['patent claim drafting best practices', 'subject matter eligibility Alice Mayo', 'EPO inventive step problem solution approach updates', 'AI inventorship patent law']
DOMAINS = ['uspto.gov', 'epo.org', 'wipo.int', 'patentscope.wipo.int']
